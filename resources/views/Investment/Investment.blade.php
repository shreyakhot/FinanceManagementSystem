    ...
    <script>
        ...
        async function deleteEntry(id) {
            if (confirm('Are you sure you want to delete this entry?')) {
                try {
                    const response = await fetch(`http://127.0.0.1:8000/api/deleteInvestment/${id}`, {
                        method: 'POST',
                        headers: {
        ...
        async function fetchEntries() {
            try {
                const response = await fetch('http://127.0.0.1:8000/api/getInvestment', {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json'
        ...
        function renderTable(data) {
            ...
            const allEntries = [...data.investment];
